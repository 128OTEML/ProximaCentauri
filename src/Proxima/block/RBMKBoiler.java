    ...
    public class RBMKBoilerBuild extends RBMKBaseBuild{
        ...
        public void updateTile(){
            ...
            if(heat > 150f && liquids != null && liquids.get(Liquids.water) > 0.1f){
                ...
                if(steamLiquids != null && ProximaLiquids.steam != null && steamLiquids.get(ProximaLiquids.steam) >= 100f){
                    steamProgress = 0f;
                } else {
                    ...
                    if(steamProgress >= 1f){
                        ...
                        if(liquids.get(Liquids.water) >= waterConsumed){
                            ...
                            // 生产蒸汽到第二个液体容量
                            if(ProximaLiquids.steam != null && steamLiquids != null){
                                steamLiquids.add(ProximaLiquids.steam, waterConsumed * 10f); // 蒸汽体积膨胀10倍
                            }
            ...
            // 自动输出蒸汽
            if(steamLiquids != null && ProximaLiquids.steam != null && steamLiquids.get(ProximaLiquids.steam) > 0.1f){
                // 直接从第二个液体容量输出蒸汽
                // 使用dumpLiquid方法输出蒸汽
                dumpSteamLiquid();
            }
        ...
        public void dumpSteamLiquid(){
            if(steamLiquids == null || ProximaLiquids.steam == null) return;
            
            Liquid liquid = ProximaLiquids.steam;
        ...
        return liquid == ProximaLiquids.steam;
        }
