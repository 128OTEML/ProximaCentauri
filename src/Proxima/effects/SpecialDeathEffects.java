...
import arc.util.*;
import Proxima.*;
import Proxima.effects.Fragmentation.*;
import Proxima.graphics.*;
import Proxima.graphics.VaporizeBatch.*;
...
public class SpecialDeathEffects{
    ...
    public Effect debrisEffect = ProximaFX.heavyDebris, sparkEffect = ProximaFX.destroySparks, explosionEffect = Fx.none;
    ...
    public static void load(){
        ...
        blood = new OrganicDeath(){{
            color.set(ProximaPal.blood);
            internalColor = ProximaPal.blood;
            colorVariation = 0.2f;
        ...
        OrganicDeath nha = new OrganicDeath(){{
            ...
            explosionEffect = new MultiEffect(ProximaFX.fragmentExplosion, lightning);
            deathSound = ProximaSounds.expElectric;
        }};
        ...
        OrganicDeath end = new OrganicDeath(){{
            ...
            explosionEffect = ProximaFX.fragmentExplosion;
            deathSound = ProximaSounds.expExotic;
        }};
    ...
    public static class ApathyDeath extends SpecialDeathEffects{
        ApathyDeath(){
            ...
            internalColor = ProximaPal.blood;
            hasInternal = true;
            deathSound = ProximaSounds.expOrganic;
        }
    ...
    public static class OrganicDeath extends SpecialDeathEffects{
        ...
        OrganicDeath(){
            ...
            //deathSound = ProximaSounds.apathyDeath;
            deathSound = ProximaSounds.expOrganic;
            hasInternal = true;
        }
