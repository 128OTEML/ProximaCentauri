...
public class ProtectedSpawner{
    ...
    private void spawnEmpathy(){
        ProtectedUnit unit = ProtectedUnit.createUnit();
        for(Team t : Team.all){
    ...
    void draw(){
        ...
        TextureRegion r1 = ProtectedRegions.magicCircle;

        Draw.color(ProximaPal.empathy, fin1 * fout1);
        ...
        if(fin3c > 0.0001f){
            ...
            for(int i = 0; i < 8; i++){
                ...
                Draw.color(ProximaPal.empathy, 0.333f * fout1);
        ...
        if(fin5 > 0.0001f){
            ...
            if(fin6c > 0.0001f){
                ...
                Draw.color(ProximaPal.empathy, 0.5f);
        ...
        ProximaShaders.thirdImpactShader.draw(Layer.flyingUnit + 3f, x, y, i3rdRad, i3rdScl, fout2);
