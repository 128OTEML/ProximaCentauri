    ...
    void hit(float x1, float y1, float x2, float y2){
        ...
        Utils.hitLaser(unit.team, 3f, x1, y1, x2, y2, null, h -> false, (h, x, y) -> {
            ...
            if(h instanceof Unit u){
                ...
                ChordonDamage.damageUnit(u, Math.max(30000f, lethal), true, Math.max(u.hitSize, u.type.legLength) < minSize ? null : () -> {
                ...
                ChordonDamage.damageBuilding(b, Math.max(30000f, lethal), true, b.block.size < 3 ? null : () -> {
