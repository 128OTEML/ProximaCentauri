    ...
    public class RBMKBoilerBuild extends RBMKBaseBuild{
        ...
        public void updateTile(){
            ...
            if(heat > 150f && liquids != null && liquids.get(Liquids.water) > 0.1f){
                ...
                if(steamLiquids != null && IcePeakLiquids.steam != null && steamLiquids.get(IcePeakLiquids.steam) >= 100f){
                    steamProgress = 0f;
                } else {
                    ...
                    if(steamProgress >= 1f){
                        ...
                        if(liquids.get(Liquids.water) >= waterConsumed){
                            ...
                            // 生产蒸汽到第二个液体容量
                            if(IcePeakLiquids.steam != null && steamLiquids != null){
                                steamLiquids.add(IcePeakLiquids.steam, waterConsumed * 10f); // 蒸汽体积膨胀10倍
                            }
            ...
            // 自动输出蒸汽
            if(steamLiquids != null && IcePeakLiquids.steam != null && steamLiquids.get(IcePeakLiquids.steam) > 0.1f){
                // 直接从第二个液体容量输出蒸汽
                // 使用dumpLiquid方法输出蒸汽
                dumpSteamLiquid();
            }
        ...
        public void dumpSteamLiquid(){
            if(steamLiquids == null || IcePeakLiquids.steam == null) return;
            
            Liquid liquid = IcePeakLiquids.steam;
        ...
        return liquid == IcePeakLiquids.steam;
        }
