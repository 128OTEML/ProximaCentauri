...
public class RBMKFuelData {
    ...
    public static void initDefaultFuels() {
        // 钚238-铍中子源
        if (IcePeakItems.plutonium238BerylliumSource != null) {
            registerFuel(IcePeakItems.plutonium238BerylliumSource, 
                new FuelProperties(1.5f, 1.2f, true, 2000f, 0.015f, 0.0008f));
        }
        
        // HEU-235铀燃料棒
        if (IcePeakItems.heu235UraniumFuel != null) {
            registerFuel(IcePeakItems.heu235UraniumFuel, 
                new FuelProperties(10f, 1.0f, false, 2000f, 0.01f, 0.001f));
        }
        
        // 钍燃料棒
        if (IcePeakItems.thoriumFuelRod != null) {
            registerFuel(IcePeakItems.thoriumFuelRod, 
                new FuelProperties(8f, 0.8f, false, 2000f, 0.008f, 0.0012f));
        }
        
        // 铀燃料棒
        if (IcePeakItems.uraniumFuelRod != null) {
            registerFuel(IcePeakItems.uraniumFuelRod, 
                new FuelProperties(12f, 1.0f, false, 2000f, 0.012f, 0.001f));
        }
        
        // 钚燃料棒
        if (IcePeakItems.plutoniumFuelRod != null) {
            registerFuel(IcePeakItems.plutoniumFuelRod, 
